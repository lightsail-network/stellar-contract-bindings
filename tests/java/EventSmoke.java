...
public class EventSmoke {
    ...
    static Client.DecodedEvent transfer(SCVal muxedId) {
        ...
        Map<SCVal, SCVal> data = new LinkedHashMap<>();
    ...
    public static void main(String[] args) {
        ...
        check("event name", parsedLegacy.getEventName().equals("TransferWithAmountOnly")
            && Client.TransferWithAmountOnlyEvent.EVENT_NAME.equals("TransferWithAmountOnly"));
        ...
        Map<SCVal, SCVal> onlyAmount = new LinkedHashMap<>();
